...
shells out with `conda run -n stt python tools/stt/stt_runner.py <wav>` and reads the recognized
...
Verify: `conda run -n stt python backend/tools/stt/stt_runner.py native_audio/napoleon_emulation.wav`
