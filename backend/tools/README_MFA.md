...
The app itself never imports MFA. `tools/align_natives.py` shells out to the env with
...
```sh
python -m tools.align_natives                 # align every practice with a native clip
